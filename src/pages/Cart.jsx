    ...
    renderCart = () => {
        return this.props.cartGlobal.cartList.map((val) => {
            return (
                ...
                <td className="align-middle">Rp. {val.price * val.quantity}</td>
                <td className="align-middle">
        ...
        <div className="p-5 text-center">
            ...
            <div className="col-9 text-center">
                ...
                <tfoot className="bg-light">
                    <tr>
                        <td colSpan="6">
                            <button onClick={this.checkoutModeToggle} className="btn btn-success" >Checkout</button>
                        </td>
                    </tr>
                </tfoot>
                </table>
                ...
                <div className="col-3">
                    ...
                    <div className="card">
                        ...
                        <div className="card-body border-top text-start">
                            ...
                            <input onChange={this.inputHandler} type="text" className="form-control mb-3" name="recepientName"/>
                            <label htmlFor="recepientAddress">Recepient Address</label>
                            <textarea onChange={this.inputHandler} type="text" className="form-control" name="recepientAddress"/>
                        </div>
